          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3 mt-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>{settings?.contactLocation || "Punjab, India"}</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Phone size={16} className="text-primary" />
                <a href={`tel:${settings?.contactPhone?.replace(/\s+/g, "") || "+919815299446"}`} className="hover:text-primary transition-colors">
                  {settings?.contactPhone || "+91 98152 99446"}
                </a>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Mail size={16} className="text-primary" />
                <a href={`mailto:${settings?.contactEmail || "counselor963@gmail.com"}`} className="hover:text-primary transition-colors">
