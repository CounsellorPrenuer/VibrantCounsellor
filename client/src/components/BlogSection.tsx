                ...
                <CardContent className="p-8 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <Avatar className="h-8 w-8 border border-primary/20">
                      <AvatarImage src={counselorPhoto} alt="Manpreet Kaur" className="object-cover" />
                      <AvatarFallback>MK</AvatarFallback>
                    </Avatar>
                    <span className="text-sm font-semibold text-muted-foreground uppercase tracking-widest text-[10px]">
                      By Manpreet Kaur
                    </span>
                  </div>
